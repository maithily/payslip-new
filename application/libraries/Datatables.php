...
if($tableName=='SALE_T_OPPORT_HEAD_VIEW' || $tableName=='SALE_T_LEAD_HEAD_VIEW' ||  $tableName=='SALE_T_QUOTE_HEAD_VIEW' || $tableName=='SALE_T_ORDER_HEAD_VIEW' || $tableName=='SALE_T_DN_HEAD_VIEW' || $tableName=='SALE_T_INV_HEAD_VIEW' )
{
  $ApproveButton = $_POST['ApproveButton'];
