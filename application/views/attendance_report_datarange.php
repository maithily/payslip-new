...
<title>Attendance Daterange Report</title>		
		<!-- begin #content -->
		<div id="content" class="content">
            ...
            <div class="row">
				...
				<div class="well">
					...
					<div class="col-md-2">
						<?php foreach($Hrs_daterange as $row) { ?>
					    <label><b><?php echo $row['checkvalue']; } ?></b></label>
					</div>
					...
					<div class="row">
					    ...
					    <thead>
						     ...
						     <th class="sorting" tabindex="0" aria-controls="data-table" rowspan="1" colspan="1" style="width: 87px;" aria-label="Name: activate to sort column ascending">Holiday</th>
                                            ...
                                            <tbody>
                                                 <?php 
							$name=$display[0]['SFT_EMP_NAME'];
							$month=$display[0]['SFT_MONTH']; 
							foreach($this->ps_model->present_status($name,$month) as $present){
								foreach($this->ps_model->Lop_status($name,$month) as $lop){
									foreach($this->ps_model->cl_status($name,$month) as $cl){
										foreach($this->ps_model->holiday_status() as $holiday){
							?>
                                                <tr>
                                                    <td><?php echo $present['ssmonth']; ?></td>
                                                     <td><?php if($lop['ssmonth']=="") { echo "0"; }else{ echo $lop['ssmonth']; } ?></td>
						    <td><?php echo $cl['ssmonth']; ?></td>
						       <td><?php echo $holiday['ssmonth']; ?></td>
