...
<head>
	...
	<link href="<?php echo site_url('application/assets/css/bootstrapValidator.min.css');?>" rel="stylesheet" />
	...
	<link href="<?php echo base_url(); ?>application/assets/datatable/buttons.dataTables.min.css" rel="stylesheet" />
	   ...
	   <link href="<?php echo base_url();?>application/assets/build/css/bootstrap-datetimepicker.min.css" rel="stylesheet" />
	   <link href="<?php echo base_url();?>application/assets/css/bootstrap-timepicker.min.css" rel="stylesheet" />
   <link href="<?php echo base_url('application/assets/LC-Switch/lc_switch.css');?>" rel="stylesheet" />
   <link href="<?php echo site_url ('application/assets/css/jquery.loader.css');?>" rel="stylesheet" />
	<!-- ================== END BASE CSS STYLE ================== -->
...
<body>
			...
			<div data-scrollbar="true" data-height="100%">
				 ...
				 <ul class="nav">
					...
					<li class="has-sub">
						...
						<li><a href="<?php echo base_url('PayslipCtr/attendanceLog')?>">Attendance Logged</a></li>
	...
	<script src="<?php echo site_url('application/assets/js/bootstrapValidator.min.js');?>"></script>
	  <script src="<?php echo site_url('application/assets/js/jquery.loader.js');?>"></script>
	<!-- ================== END BASE JS ================== -->
	...
	<script src="<?php echo base_url(); ?>application/assets/datatable/vfs_fonts.js"></script>
	<script src="<?php echo base_url(); ?>application/assets/datatable/pdfmake.min.js"></script>
	<script src="<?php echo base_url(); ?>application/assets/datatable/jszip.min.js"></script>
	...
	<script src="<?php echo base_url();?>application/assets/build/moment.js"></script>
	<script src="<?php echo base_url();?>application/assets/build/js/bootstrap-datetimepicker.min.js"></script>
<script src="<?php echo base_url();?>application/assets/LC-Switch/lc_switch.js"></script>
