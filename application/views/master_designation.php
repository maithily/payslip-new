...
<h4 class="panel-title">Settings for Designation</h4>
</div>
<div class="panel-body">
	
<div class="well">	
	
<legend> Settings for Adding Designation</legend>
<div class="row">
	<form action="<?php echo base_url('PayslipCtr/master_designation');?>" method="post" id="forms">
		<div class="conatnier">
			<div class="col-md-12">
				<div class="row">
				<div class="col-md-4">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-7">
                                           <input type="text" class="form-control textfield1" style="text-transform: capitalize;" name="designation" id="designation" placeholder="Add Designation" />
				...
				<div class="col-md-4">
                                    <div class="form-group">
                                      <div class="col-md-4">
                                    <button type="submit" name="add_desig" id="Add" value="add" class="btn btn-sm btn-success form-control">Add</button>
...
var id=$id;
$.ajax({
url:'<?php echo site_url('payslipCtr/master_designation_delete');?>',
type:"post",
data:{id:id},
...
var id=$id;
$.ajax({
url:'<?php echo site_url('payslipCtr/master_designation_edit');?>',
type:"post",
data:{id:id},
dataType:'json',
success:function(json){
	
$("#designation").val(json.getData[0].designation);
...
function Update_fun() {
	...
	$.ajax({
	url:'<?php echo site_url('payslipCtr/master_designation_update');?>',
	type:"post",
	data:{id:id,desig:desig},
