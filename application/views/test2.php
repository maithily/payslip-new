        ...
        <div class="content" style="border: 2px solid black;">
                ...
                <table style="width: 100%" cellspacing="5">
                   <tr>
                        ...
                        <td colspan="2" style="text-align: left;width: 20%"><?php echo $datas2[0]['EMP_NAME']?></td>
                        <th colspan="2" style="text-align: left;width: 27%">Employee Id</th>
                        <th colspan="2" style="text-align: left;width: 2%">:</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?php echo $datas2[0]['EMP_ID']; ?></td>
                    </tr>
                    <tr>
                        <th colspan="2" style="text-align: left;width: 27%">Department</th>
                        <th colspan="2" style="text-align: left;width: 2%">:</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?Php echo $datas2[0]['EMP_DEPARTMENT'] ?></td>
                        <th colspan="2" style="text-align: left;width: 27%">Designation</th>
                        <th colspan="2" style="text-align: left;width: 2%">:</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?Php echo $datas2[0]['DESIGNATION'] ?></td>
                    </tr>
                    <tr>
                        <th colspan="2" style="text-align: left;width: 27%">Pay Date</th>
                        <th colspan="2" style="text-align: left;width: 2%">:</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?Php echo $datas2[0]['PAY_DATE'] ?></td>
                        <th colspan="2" style="text-align: left;width: 27%">Date of Joining</th>
                        <th colspan="2" style="text-align: left;width: 2%">:</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?Php echo $datas2[0]['JOIN_DATE'] ?></td>
                    </tr>
                    <tr>
                        <th colspan="2" style="text-align: left;width: 27%">Working Days</th>
                        <th colspan="2" style="text-align: left;width: 2%">:</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?php echo $datas2[0]['TOTAL_WORKING_DAYS']; ?></td>
                        <th colspan="2" style="text-align: left;width: 27%">Days Worked</th>
                        <th colspan="2" style="text-align: left;width: 2%"> :</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?php echo $datas2[0]['WORKED_DAYS']; ?></td>
                    </tr>
                    <tr>
                        <th colspan="2" style="text-align: left;width: 27%">Payslip No:</th>
                        <th colspan="2" style="text-align: left;width: 2%">:</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?php echo $datas2[0]['PAYSLIP_NO']; ?></td>
                        <th colspan="2" style="text-align: left;width: 27%">Bank Account Number</th>
                        <th colspan="2" style="text-align: left;width: 2%">:</th>
                        <td colspan="2" style="text-align: left;width: 20%"><?Php echo $datas2[0]['ACCOUNT_NO'] ?></td>
                    </tr>
            </table>
...
-->                        <th style="text-align: left;width: 25%;border-top:1px solid;border-bottom: 1px solid;border-left: 1px solid" >Deduction</th>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;width: 25%; "><?Php echo $datas2[0]['BASIC_SALARY'] ?></td>
                        <th style="text-align: left;width: 25%;border-left:1px solid" >LOP</th>
                        <td style="text-align: center;width: 25%;"><?Php echo $datas2[0]['LOP'] ?></td>
                    </tr>
                    <tr>
                        <th style="text-align: left;width: 25%;">HRA</th>
                        <td style="text-align: center;width: 25%;"><?Php echo $datas2[0]['HRA'] ?></td>
                        <th style="text-align: left;width: 25%;border-left:1px solid">Advance Salary</th>
                        <td style="text-align: center;width: 25%;"><?Php echo $datas2[0]['ADVANCE_SALARY'] ?></td>
                    </tr>
                    <tr>
                        <th style="text-align: left;width: 25%;">DA</th>
                        <td style="text-align: center;width: 25%;"><?Php echo $datas2[0]['DA'] ?></td>
                        <th style="text-align: left;width: 25%;border-left:1px solid">Other Deduction</th>
                        <td style="text-align: center;width: 25%;"><?Php echo $datas2[0]['OTHER_DEDUCTIONS'] ?></td>
                    </tr>
                    <tr>
                        <th style="text-align: left;width: 25%;">TA</th>
                        <td style="text-align: center;width: 25%;border-right:1px solid"><?Php echo $datas2[0]['TRAVELLING_ALLOWANCE'] ?></td>
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;width: 25%;border-right:1px solid"><?Php echo $datas2[0]['INCENTIVE'] ?></td>
                        <th style="text-align: left;width: 25%;color: white;border-right:1px solid" >ESI</th>
                        <td style="text-align: center;width: 25%;color: white;">25.00</td>
                    </tr>
                    <tr>
                        <th style="text-align: left;width: 25%;">Increment</th>
                        <td style="text-align: center;width: 25%;border-right:1px solid;"><?Php echo $datas2[0]['INCREMENT'] ?></td>
                    ...
                    <tr>
                        ...
                        <th style="text-align: center;width: 25%;border-top:1px solid;border-bottom: 1px solid;">5500</th>
                        ...
                        <th style="text-align: center;width: 25%;border-top:1px solid;border-bottom: 1px solid"><?php echo $datas2[0]['GROSS_DEDUCTIONS']; ?></th>
                    </tr>
                </thead>
            </table>
            ...
            <table class="netpay" width="100%" style="border-bottom: 1px solid;" cellspacing="5">
                ...
                <!--    <tr>
                    ...
                    <tr>
                        ...
                        <th class="net2" style="text-align: left;width: 15.3%"><?php echo $datas2[0]['NET_AMOUNT'] ?></th>
                        <th class="net" style="text-align: left;width: 7.5%">In Words</th>
                        <th class="net1" style="text-align: left;width: 1%">:</th>
                        <th class="net2" style="text-align: left;width: 41%"><?php echo $datas2[0]['IN_WORD'] ?></th>
                    </tr>
                   <!-- <tr>
...
<!--            <table style="" class="footer1" width="100%" cellspacing="5" cellpadding="0">
                <thead>
                    <tr>
                        <th style="text-align: left;width: 30%;color: white;border-bottom: 1px solid black">Employer's Signature</th>
                        <th style="text-align: right;width: 40%;color: white">:</th>
                        <th style="text-align: left;width: 30%;color: white;border-bottom: 1px solid black">Employee's Signature</th>
                    </tr>
                    <br>

                    <tr>
                        <th colspan="2" style="text-align: left;width: 30%;">Employer's Signature</th>
                        <th style="text-align: right;width: 40%;color: white">:</th>
                        <th colspan="2" style="text-align: left;width: 30%;">Employee's Signature</th>
                    </tr>
                </thead>
            </table>
-->        </div>
